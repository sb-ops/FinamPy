...
# REST API - Структуры
import FinamPy.proto.candles_pb2 as proto_candles  # Свечи https://finamweb.github.io/trade-api-docs/rest-api/candles
import FinamPy.proto.common_pb2 as proto_common  # Описание общих типов https://finamweb.github.io/trade-api-docs/rest-api/common-types
import FinamPy.proto.events_pb2 as proto_events  # События
import FinamPy.proto.orders_pb2 as proto_orders  # Заявки https://finamweb.github.io/trade-api-docs/rest-api/orders
import FinamPy.proto.portfolios_pb2 as proto_portfolios  # Портфели https://finamweb.github.io/trade-api-docs/rest-api/portfolios
import FinamPy.proto.security_pb2 as proto_security  # Инструменты https://finamweb.github.io/trade-api-docs/rest-api/securities
import FinamPy.proto.stops_pb2 as proto_stops  # Стоп-заявки https://finamweb.github.io/trade-api-docs/rest-api/stops

# gRPC - Сервисы
from FinamPy.grpc.candles_pb2_grpc import CandlesStub  # Сервис свечей
from FinamPy.grpc.events_pb2_grpc import EventsStub  # Сервис подписок https://finamweb.github.io/trade-api-docs/grpc/events
from FinamPy.grpc.orders_pb2_grpc import OrdersStub  # Сервис заявок https://finamweb.github.io/trade-api-docs/grpc/orders
from FinamPy.grpc.portfolios_pb2_grpc import PortfoliosStub  # Сервис портфелей https://finamweb.github.io/trade-api-docs/grpc/portfolios
import FinamPy.grpc.securities_pb2 as grpc_securities  # Структуры тикеров
from FinamPy.grpc.securities_pb2_grpc import SecuritiesStub  # Сервис тикеров https://finamweb.github.io/trade-api-docs/grpc/securities
from FinamPy.grpc.stops_pb2_grpc import StopsStub  # Сервис стоп заявок https://finamweb.github.io/trade-api-docs/grpc/stops
